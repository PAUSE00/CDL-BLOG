    ...
    <div class="glass border border-white/10 rounded-3xl p-10 max-w-lg w-full text-center animate-scale-in relative overflow-hidden">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-center mb-6">
                <span class="text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-neon-cyan to-neon-purple drop-shadow-[0_0_15px_rgba(0,243,255,0.5)] animate-pulse-neon">404</span>
            </div>
            ...
            <h1 class="text-3xl font-bold font-display text-white mb-4">Page introuvable</h1>
            <p class="text-gray-400 mb-8 leading-relaxed max-w-xs mx-auto">La page que vous essayez de consulter n'existe pas ou a été déplacée.</p>
